...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn(navigationMenuTriggerStylePrimary(), "group", className)}
      {...props}
    >
      {children}{" "}
      <ChevronDownIcon
