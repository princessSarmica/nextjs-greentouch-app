        ...
        <main className="flex flex-col items-center justify-start w-full min-h-screen bg-[#f5f5f5] text-gray-900">
            ...
            <section className="w-full max-w-5xl mx-auto px-4 pt-8">
                <p className="text-base font-semibold mb-4 text-gray-700"> 
                    Welcome to GreenTouch Session 7!
                </p>
                <p className="text-base mb-4 text-gray-700"> 
                    Step again into your nature experience. This session focuses on finding a safe and comfortable space in nature where you feel at home.
                </p>
                <p className="text-base mb-4 text-gray-700"> 
                ...
                <div className="bg-white rounded-lg shadow p-8 mb-10 mt-10">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                        ...
                        <li>
                            ...
                            Find a natural space that feels safe and inviting. Spend time there, noticing how different areas make you feel—open, enclosed, peaceful. Allow yourself to fully experience the space.
                        </li>
                        <li>
            ...
            <section className="w-full max-w-5xl mx-auto px-4">
                <div className="bg-white rounded-lg shadow p-8 mb-10">
                    ...
                    <ul className="list-disc mb-4 pl-6 space-y-2 text-gray-700">
                        <li>
                            Choose a video from any section that makes you feel calm and comfortable, as if it were your personal retreat. Imagine stepping into this environment, feeling its protective energy, and noticing how your body responds when immersed in this positive space.
                        </li>
                    </ul>
