...
export default async function SessionFivePage() {
    ...
    const dbSession = await getGreentouchSessionByName("session-5");

    const completedSessions = await getAllCompletedGreentouchSessions();
    const previousSession = await getGreentouchSessionByName("session-4");
        ...
        <main className="flex flex-col items-center justify-start w-full min-h-screen bg-[#f5f5f5] text-gray-900">
            ...
            <section className="w-full max-w-5xl mx-auto px-4 pt-8">
                <div className="text-sm text-gray-500 mb-20">
                    <Link href="/sessions" className="text-[#1F566E] hover:underline font-medium">
                        {t('greentouchSessions.session5.breadcrumbItem1')}
                    </Link>
                    <span className="mx-2">&gt;</span>
                    <span>{t('greentouchSessions.session5.breadcrumbItem2')}</span>
                </div>
                ...
                <div className="flex justify-between items-center mb-10 underline">
                    ...
                    >
                        {t('greentouchSessions.session5.leftNavigationLink')}
                    </Link>
                    ...
                    <Link
                        ...
                        className="text-[#1F566E] hover:underline font-medium flex items-center gap-1"
                    >
                        {t('greentouchSessions.session5.rightNavigationLink')}
                    </Link>
                </div>

                <p className="text-xl font-semibold mb-4 text-left text-green-800">{t('greentouchSessions.session5.titleCapitals')}</p>
                <h1 className="text-3xl font-bold mb-8 text-left">{t('greentouchSessions.session5.description')}</h1>
                <p className="text-lg mb-4 text-gray-700"></p>
                <p className="text-lg mb-2  font-semibold text-green-800"> 
                    {t('greentouchSessions.session5.labelGoal')}
                </p>
                <p className="text-lg mb-4 text-gray-700"> 
                    {t('greentouchSessions.session5.paragraph1')}
                </p>
            ...
            <section className="w-full max-w-5xl mx-auto px-4 pt-8">
                <p className="text-base font-semibold mb-4 text-gray-700"> 
                    {t('greentouchSessions.session5.welcomeTitle')}
                </p>
                <p className="text-base mb-4 text-gray-700"> 
                    {t('greentouchSessions.session5.welcomeParagraph1')}
                </p>
                <p className="text-base mb-4 text-gray-700"> 
                    {t('greentouchSessions.session5.welcomeParagraph2')}
                </p>
            </section>
            ...
            <section className="w-full max-w-5xl mx-auto px-4">
                <div className="bg-white rounded-lg shadow p-8 mb-10 mt-10">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h3 className="text-xl font-semibold">{t('greentouchSessions.session5.outdoorTaskCard.cardTitle')}</h3>
                        <span className="ml-3 text-xs font-semibold bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-center">
                            {t('greentouchSessions.session5.outdoorTaskCard.requiredLabel')}
                        </span>
                    </div>
                    ...
                    <h4 className="text-xl font-semibold mb-3">{t('greentouchSessions.session5.outdoorTaskCard.taskTitle')}</h4>
                    <p className="text-base mb-4 text-gray-700">
                        {t('greentouchSessions.session5.outdoorTaskCard.taskDescription')}
                    </p>

                    <ul className="list-disc pl-6 space-y-2 text-gray-700">
                        <li>
                            <span className="font-semibold text-green-800">{t('greentouchSessions.session5.outdoorTaskCard.step1')}</span><br/> 
                            {t('greentouchSessions.session5.outdoorTaskCard.step1taskInstructions')}
                        </li>
                        <li>
                            <span className="font-semibold text-green-800">{t('greentouchSessions.session5.outdoorTaskCard.step2')}</span><br/> 
                            {t('greentouchSessions.session5.outdoorTaskCard.step2taskInstructions')}
                        </li>
                        <li>
                            <span className="font-semibold text-green-800">{t('greentouchSessions.session5.outdoorTaskCard.step3')}</span><br/> 
                            {t('greentouchSessions.session5.outdoorTaskCard.step3taskInstructions')}                  
                        </li>
                    </ul>

                    <p className="text-base mb-4 text-gray-700 mt-4">
                        {t('greentouchSessions.session5.outdoorTaskCard.endMessage')}
                    </p>
                </div>
            </section>
            ...
            <section className="w-full max-w-5xl mx-auto px-4">
                <div className="bg-white rounded-lg shadow p-8 mb-10">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h3 className="text-xl font-semibold">{t('greentouchSessions.session5.indoorTaskCard.cardTitle')}</h3>
                        <span className="ml-3 text-xs font-semibold bg-amber-200 text-amber-600 px-2 py-0.5 rounded-full text-center">
                            {t('greentouchSessions.session5.indoorTaskCard.requiredLabel')}
                        </span>
                    </div>

                    <p className="text-base mb-4 text-gray-700">
                        {t('greentouchSessions.session5.indoorTaskCard.taskDescription')}
                    </p>

                    <ul className="list-disc mb-4 pl-6 space-y-2 text-gray-700">
                        <li>
                            {t('greentouchSessions.session5.indoorTaskCard.taskInstructions')}
                        </li>
                    </ul>
                    ...
                    <div className="flex justify-end">
                        <Button asChild variant={"secondary"}>
                            <Link href="/nature-video-gallery">
                                {t('greentouchSessions.session5.indoorTaskCard.natureVideoGalleryLink')} &rarr;
                            </Link>
                        </Button>
                    </div>
                </div>
            ...
            <DiaryCard 
                diaryCardTranslations={{
                    ...
                    localName: t("greentouchSessions.session5.localName"),
                    diaryQuestions: [t("greentouchSessions.session5.diaryQuestions.question1"), t("greentouchSessions.session5.diaryQuestions.question2")],
